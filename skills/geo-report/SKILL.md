...
The composite GEO Score formula and the canonical per-dimension weights live in one place: **`../geo/references/scoring.md`** (`~/.claude/skills/geo/references/scoring.md`). Use that formula — Citability 25% / Brand 20% / E-E-A-T 20% / Technical 15% / Schema 10% / Platform 10% — and do not re-derive weights here. Round to the nearest integer. Cap at 100.
...
| Technical Foundation | XX/100 | 15% | XX |
| Schema & Structured Data | XX/100 | 10% | XX |
| AI Platform Readiness | XX/100 | 10% | XX |
| **Overall** | | | **XX/100** |
```
...
- AI search is projected to drive 25-40% of organic discovery by end of 2026 (Feb-2026 industry estimate; verify before quoting)
