# AI Crawler Roster (Canonical Reference)

> **Snapshot last verified 2026-03; UA strings and user counts churn — re-verify before client use.**

This is the single canonical AI-crawler roster for the GEO skill pack. The `geo-crawlers` skill (access analysis) and `geo-technical` skill (§1.2 AI crawler access) both point here instead of keeping their own copies.
