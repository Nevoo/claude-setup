...
This skill is the canonical E-E-A-T home for the GEO pack. The weights below (25% per dimension plus the topical-authority modifier) are also recorded in `../geo/references/scoring.md`. The stale `geo-content` agent weighted E-E-A-T at 15% each inside a broader mix — the skill weights below win.
